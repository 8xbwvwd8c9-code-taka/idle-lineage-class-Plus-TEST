...
| 加詞綴來源(製作出遠古系 / 遺物可祝福) | `docs/affix-sources.md`(**規劃·尚未實作**;兩案的掛接點、要決定的事、既有 afk-ancdrop 的關係) |
...
- **架構=「上游原版鏡像＋外掛層」**:核心(`js/NN-*.js`、`css/*`、`index.html`、`assets/`、`public/`)永遠是上游原文/原檔的位元組級鏡像;我們的所有功能都在**外掛層**——根目錄 `afk-*.js`(68 支)＋`sw.js`(PWA,上游沒有)＋極少量**錨點式核心補丁**(`scripts/apply-core-patches.mjs`)。
