...
## 核心補丁(10 組·14 處錨點;`scripts/apply-core-patches.mjs`)

`--check` 印的數字(14)是錨點處數,不是補丁組數。
...
## 外掛(71 支;載入順序見 `scripts/afk-plugin-block.html`)
