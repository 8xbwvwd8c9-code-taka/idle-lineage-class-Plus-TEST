...
(function () {
    ...
    [
        ...
        { id: 'mapbar', name: '手機地圖列壓縮', desc: '手機的冒險地圖標題列壓成兩排，少佔畫面（僅手機）', group: '遊戲介面' },
        { id: 'battlehud', name: '手機戰鬥狀態列', desc: '手機戰鬥畫面上方多一排：等級、防禦、金幣、經驗與血魔量（僅手機）', group: '遊戲介面' },
        { id: 'nozoom', name: '手機取消雙擊放大', desc: '手機連點兩下不會放大畫面（兩指縮放照常；僅手機）', group: '遊戲介面' },
        { id: 'battlebuffs', name: '手機戰鬥狀態欄', desc: '手機在戰鬥框下方直接顯示增益、異常與魔物追蹤（僅手機）', group: '遊戲介面' },
        ...
        { id: 'backnav', name: '手機返回鍵', desc: '手機按返回鍵回上一層，不會直接關掉 App（僅手機）', group: '遊戲介面' },
        { id: 'dex', name: '怪物/掉落查詢', desc: '查怪物、地圖與掉落物（首頁入口）', group: '查詢與資訊' },
        { id: 'wiki', name: '小百科', desc: '查職業、裝備、機制、地圖等資料（首頁入口）', group: '查詢與資訊' },
        { id: 'slotinfo', name: '選角掛機資訊', desc: '選角畫面顯示每個角色掛在哪張圖、掛了多久', group: '查詢與資訊' },
        { id: 'loadslots', name: '選角 16 格分頁', desc: '選角畫面從 8 格擴充到 16 格', group: '查詢與資訊' },
        { id: 'history', name: '離線掛機紀錄', desc: '在設定選單查最近幾次的離線結算紀錄', group: '查詢與資訊' },
        { id: 'diag', name: '快取診斷', desc: '回報問題時用的取證工具（設定選單）', group: '查詢與資訊' },
        ...
        { id: 'dograce', name: '賽狗場', desc: '奇岩的賭狗小遊戲，只賺金幣（自動化分頁開啟）', group: '遊戲玩法' }
