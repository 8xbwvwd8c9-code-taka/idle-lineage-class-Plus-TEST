 ...
 *
 * 城堡系統補丁（castleBuildingsData / castleButlerNPC / castleBuildingCollection /
 * castleExpGoldBonus / castleButlerNpcList / castleBuildingStats / castleEnchantRate /
 * clanBuffExtraMp）已抽到 apply-castle-patches.mjs，由下方匯入並展開進 PATCHES 統一註冊。
 *
 * 用法：node scripts/apply-core-patches.mjs        （--check 只驗證是否已全部補上、不寫檔）
 */
import { readFileSync, writeFileSync } from 'node:fs';
import { castlePatches } from './apply-castle-patches.mjs';
